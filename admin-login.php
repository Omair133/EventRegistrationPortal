...
if(isset($_POST['login'])){
    if(empty($_POST['email']) || empty($_POST['password'])){
        ...
        if($_POST['email']=="rd_msit" && $_POST['password']=="rd_msit"){
...
<html>
	...
	<header data-stellar-background-ratio="0.5" id="home">
		...
		<section class="participant-login-section">
			<h1>Admin Login</h1>
			<p style="text-align:center">For admin purpose only. The admin is responsible for assigning events to the participants.</p>
